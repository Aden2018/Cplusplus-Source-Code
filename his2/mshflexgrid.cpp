...
void CMSHFlexGrid::SetCols( long nNewValue)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4;
	InvokeHelper(0x5, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH CMSHFlexGrid::GetFont()
{
	LPDISPATCH result;
...
LPDISPATCH CMSHFlexGrid::GetFontFixed()
{
	LPDISPATCH result;
...
LPDISPATCH CMSHFlexGrid::GetFontBand(long BandNumber)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x92, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms,
		BandNumber);
	return result;
}
...
LPDISPATCH CMSHFlexGrid::GetFontHeader(long BandNumber)
{
	LPDISPATCH result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x85, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, parms,
		BandNumber);
	return result;
}
...
LPDISPATCH CMSHFlexGrid::GetMouseIcon()
{
	LPDISPATCH result;
...
LPDISPATCH CMSHFlexGrid::GetPicture()
{
	LPDISPATCH result;
...
LPDISPATCH CMSHFlexGrid::GetCellPicture()
{
	LPDISPATCH result;
...
void CMSHFlexGrid::SetColWidth(long Index, long nNewValue)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4;
	InvokeHelper(0x39, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
LPDISPATCH CMSHFlexGrid::GetRecordset()
{
	LPDISPATCH result;
